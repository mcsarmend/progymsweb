...
class SpGetAsistenciasYAusenciasPorSemanaGeneral extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $procedure = "DROP PROCEDURE IF EXISTS `sp_get_asistencias_y_ausencias_por_semana_general`;
