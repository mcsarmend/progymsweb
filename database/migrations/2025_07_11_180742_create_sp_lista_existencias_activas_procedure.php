...
class CreateSpListaExistenciasActivasProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $procedure = <<<SQL
            DROP PROCEDURE IF EXISTS lista_existencias_activas;
            CREATE PROCEDURE lista_existencias_activas()
            BEGIN
                SELECT
                    p.id AS codigo,
    ...
    {
        Schema::dropIfExists('sp_lista_existencias_activas_procedure');
    }
}
