...
class CreateSpGetAsistenciasYAusenciasPorSemanaGeneralProcedure extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */  public function up()
    {
        $procedure = <<<SQL
            ...
            CREATE PROCEDURE sp_get_asistencias_y_ausencias_por_semana_general(    IN fecha_inicio DATE,IN fecha_fin DATE)
            begin
                    SELECT
    ...
    {
        Schema::dropIfExists('sp_get_asistencias_y_ausencias_por_semana_general_procedure');
    }
}
