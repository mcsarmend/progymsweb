...
class CreateSpListaPreciosActivosProcedure extends Migration
{
    ...
    public function up()
    {
     ...
     SELECT
            ...
            GROUP BY
                p.id, p.nombre, b.nombre, c.nombre, precio_publico.price, precio_frecuente.price,precio_mayoreo.price, precio_distribuidor.price,precio_black.price, precio_platinum.price;
            END
    SQL;
