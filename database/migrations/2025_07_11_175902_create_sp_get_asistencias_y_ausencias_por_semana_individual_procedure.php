...
class CreateSpGetAsistenciasYAusenciasPorSemanaIndividualProcedure extends Migration
{
    /**
     * Run the migrations.
     *
  ...
  public function up()
    ...
    {
        Schema::dropIfExists('sp_get_asistencias_y_ausencias_por_semana_individual_procedure');
    }
}
