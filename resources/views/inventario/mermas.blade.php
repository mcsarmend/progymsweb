...
@section('content')
    <div class="card">
        <div class="card-header">
            <h2>Inventario > Mermas</h2>
        </div>
        <div class="card-body">
            <div class="card">
                <div class="card-body">
                    <form method="post" id="enviarmerma">
                        <div class="row">
...
@section('js')
    ...
    <script>
        ...
        $('#enviarmerma').submit(function(e) {
            ...
            Swal.fire({
                title: '¡Se realizará un mermado de mercancia!',
                ...
                if (result.isConfirmed) {
                    ...
                    numeroRemision = enviarmerma("DECREASE", datos, documento, sum, sucursal);

                }
            });
        });

        function enviarmerma(movimiento, data, documento, suma, sucursal) {
            ...
            $.ajax({
                url: 'enviarmerma', // URL a la que se hace la solicitud
