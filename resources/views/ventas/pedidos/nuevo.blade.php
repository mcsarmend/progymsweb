        ...
        <div class="card-body">
            ...
            <form id="nuevopedido">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <textarea id="nota" name="nota" rows="3" class="form-control" placeholder="Escribe tu texto aquí..."></textarea>
                    </div>
...
@section('js')
    ...
    `);
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    numeroRemision = validarRemision(
                        idsucursal, hora, nota, vendedor, cliente, $productoTableClone2
                    );
                }
            });
        });
        ...
        function validarRemision(idsucursal, hora, nota, vendedor, cliente, $productoTableClone2) {
            ...
            var msg = "";
            $.ajax({
                url: 'crearnuevopedido', // URL a la que se hace la solicitud
                type: 'POST', // Tipo de solicitud (GET, POST, etc.)
                data: data,
                dataType: 'json', // Tipo de datos esperados en la respuesta
                headers: {
