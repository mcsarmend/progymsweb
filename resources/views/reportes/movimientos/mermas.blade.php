...
@section('title', 'Reportes de Movimientos mermas')
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h1>Reportes de Movimientos mermas</h1>
        </div>
        <div class="card-body">
            <form id="reporte">
                <div class="row">
            ...
            <table id="mermas" class="table table-striped">
                <thead>
                    <tr>
                        <th>Fecha</th>
                        <th>Movimiento</th>
...
@section('js')
    <script>
        ...
        $('#reporte').submit(function(e) {
            ...
            $.ajax({
                url: '/generarreportemermas', // Ruta al controlador de Laravel
                type: 'GET',
