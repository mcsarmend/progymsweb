...
@section('title', 'Resumen de Ventas por Producto')
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" id="reporteventasproducto" class="border p-3 rounded">
...
@section('js')
    ...
    <script>
        ...
        $('#reporteventasproducto').submit(function(e) {
            ...
            $.ajax({
                url: '/generarreporteventasproducto', // Ruta al controlador de Laravel
                type: 'POST',
